...
export const SportsCoachDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'teams' | 'training' | 'events' | 'messenger' | 'submissions'>('teams');
  ...
  const [teacherSubject, setTeacherSubject] = useState(profile?.subject || 'Sports');
  ...
  const handleAddAssignment = async (e: React.FormEvent) => {
    ...
    try {
      await addDoc(collection(db, 'assignments'), {
        ...
        teacherName: profile.displayName || 'Coach',
  ...
  return (
    <div className="space-y-8">
      ...
      {announcements.length > 0 && (
        <div className="bg-blue-600 text-white p-6 rounded-[2.5rem] shadow-xl shadow-blue-100 dark:shadow-none mb-8">
      ...
      <div className="flex gap-6 border-b border-slate-100 dark:border-slate-800 overflow-x-auto whitespace-nowrap pb-px scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
        {[
      ...
      {activeTab === 'teams' ? (
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-slate-900 dark:text-white">My Sport/Team:</span>
                <input 
                  type="text" 
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm space-y-4">
            ...
            <button 
              onClick={() => setActiveTab('training')}
              className="w-full py-3 bg-amber-600 text-white rounded-xl font-bold text-sm"
            >
              Manage Club
            </button>
          </div>
          ...
          {isAddingAssignment && (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input 
                  type="text" 
                  placeholder="Assignment Title (e.g. 5km Run Practice)" 
              ...
              <div key={assign.id} className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm relative">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button 
                    ...
                    className="p-3 text-red-600 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-red-300 dark:hover:border-red-900 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-2xl transition-all active:scale-95 shadow-sm flex items-center justify-center shrink-0"
